...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await bot.send_file("@BotFather", "PPF22/logozed.jpg")
            await asyncio.sleep(3)
...
zthon = {"@Tepthon", "@Tepthone1", "@Tws_Tepthon", "@P17_12"}
async def saves():
   for Cat in zthon:
        try:
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        print(
            "المجموعه الخاصه لفار الـ PRIVATE_GROUP_BOT_API_ID تم حفظه بنجاح و إضافة الفار اليه."
        )
        flag = True
