...
ZelzalChecler_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗧𝗲𝗽𝘁𝗵𝗼𝗻 - اوامـر الصيـد والتشيكـر](t.me/Tepthon) 𓆪\n\n"
    ...
    "`.تثبيت` + اليوزر\n"
    "**⪼ لـ تثبيت اليـوزر بقنـاة معينـه اذا اصبح متـاحًا يتم اخـذه**\n"
    "`.ثبت` + اليوزر\n"
    "**⪼ لـ تثبيت اليـوزر بحسـابك مباشـرة اذا اصبح متـاحًا يتم اخـذه**\n"
    "`.حالة الصيد`\n"
    "**⪼ لـ معرفـة حالـة تقـدم عمليـة الصيـد**\n"
    "`.حالة التثبيت`\n"
    "**⪼ لـ معرفـة حالـة تقـدم التثبيت التلقـائـي**\n"
    "`.ايقاف الصيد`\n"
    "**⪼ لـ إيقـاف عمليـة الصيـد الجاريـة**\n"
    "`.ايقاف التثبيت`\n"
...
async def hunterusername(event):
    ...
    try:
        if replly and replly.text.startswith('@'): #Code Update by @zzzzl1l
            ch = replly.text
            await event.edit(f"**𓆰 تم بـدء الصيـد .. بنجـاح ☑️**\n**𓆰 النـوع** {choice} \n**𓆰 على القنـاة** {ch} \n**𓆰 لمعرفـة تقـدم عمليـة الصيـد (** `.حالة الصيد` **)**\n**𓆰 لـ ايقـاف عمليـة الصيـد (** `.ايقاف الصيد` **)**")
        else:
            ch = await zedub(
