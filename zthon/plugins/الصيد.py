...
ZelzalChecler_cmd = (
    "𓆩 [𝘀𝗼𝘂𝗿𝗰𝗲 𝘁𝗲𝗽𝘁𝗵𝗼𝗻 - اوامـر الصيـد والتشيكـر](t.me/Tepthon) 𓆪\n\n"
    ...
    "`.تثبيت` + اليوزر\n"
    "**⪼ لـ تثبيت اليـوزر بقنـاة معينة اذا اصبح متاحًا يتم اخـذه**\n\n"
    "`.حالة الصيد`\n"
        ...
        if isav == True:
            try:
                ...
                await event.client.send_message(
                    event.chat_id,
                    "ᯓ 𝗧𝗲𝗽𝘁𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - صيـد تيبثــون 💡\n**•────────────────────•**\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Channel ❳\n**•────────────────────•**\n- By ❲ @ZedThon ❳ ".format(
    ...
    while swapmod:
        ...
        if isav == True:
            try:
                ...
                await event.client.send_message(
                    ch,
                    "ᯓ 𝗧𝗲𝗽𝘁𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - صيـد تيبــثـون 💡\n**•────────────────────•**\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Save: ❲ Channel ❳\n**•────────────────────•**\n- By ❲ @Tepthon ❳ ".format(
                        username, trys2
                    ),
                )
                await event.client.send_message(
                    event.chat_id,
                    "ᯓ 𝗧𝗲𝗽𝘁𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - صيـد تيبــثون 💡\n**•────────────────────•**\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Save: ❲ Channel ❳\n**•────────────────────•**\n- By ❲ @Tepthon ❳ ".format(
                        username, trys2
                    ),
                )
                await event.client.send_message(
