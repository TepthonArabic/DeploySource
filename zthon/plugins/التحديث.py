...
@zedub.zed_cmd(
    ...
    info={
        "header": "لـ تحـديث بــوت تــيـبثون",
        "الاستـخـدام": [
            "{tr}تحديث",
            "{tr}تحديث الان",
            "{tr}تحديث البوت",
