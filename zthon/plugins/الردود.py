...
ZelzalWF_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗧𝗲𝗽𝘁𝗵𝗼𝗻 𝗖𝗼𝗻𝗳𝗶𝗴 - اوامـر الـردود / والتـرحيب](t.me/Tepthon) 𓆪\n\n"
    "**✾╎قائـمه اوامـر الـردود 🦾 :** \n\n"
    "**⎞𝟏⎝** `.رد`\n"
    "**•• ⦇الامـر + اسـم الـرد بالـرد ع كلمـة الـرد او بالـرد ع ميديـا⦈ لـ إضـافة رد بالجـروب**\n\n"
    "**⎞𝟐⎝** `.حذف رد`\n"
    ...
    "\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙏𝙀𝙋𝙏𝙃𝙊𝙉](t.me/Tepthon) 𓆪"
)
...
async def on_snip_list(event):
    ...
    filters = get_filters(event.chat_id)
    for filt in filters:
        if OUT_STR == "** ❈╎لاتوجـد ردود في هـذه الدردشـة ༗**":
            OUT_STR = "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝙏𝙀𝙋𝙏𝙃𝙊𝙉 - 𝙏𝙀𝙋𝙏𝙃𝙊𝙉 𝑭𝑰𝑳𝑻𝑬𝑹𝑺 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**  ⪼ قائمـه الـردود في هذه الدردشـة :  **\n"
        OUT_STR += "⪼ {}  𓆰.\n".format(filt.keyword)
    await edit_or_reply(
        event,
        OUT_STR,
        caption="**⧗╎الـردود المضـافـه في هـذه الدردشـة هـي :**ش",
...
async def on_all_snip_delete(event):
    ...
    if filters:
        ...
        await edit_or_reply(event, "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝙏𝙀𝙋𝙏𝙃𝙊𝙉 - 𝙏𝙀𝙋𝙏𝙃𝙊𝙉 𝑭𝑰𝑳𝑻𝑬𝑹𝑺 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⪼ تم حذف جـميع الــردود المضـافـهہ بنجـاح☑️**")
    else:
