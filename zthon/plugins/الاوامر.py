...
async def zed_handler(event):
    ...
    if query.startswith("زدثون") and event.query.user_id == zedub.uid:
        ...
        buttons = [[Button.url("قنـاة السـورس", "https://t.me/Tepthon"),],[Button.url("التحـديثـات", "https://t.me/Zed_Thon"), Button.url("الفـارات", "https://t.me/zzzvrr"),],[Button.url("الشـروحـات¹", "https://t.me/zzzlvv"),],[Button.url("الشـروحـات²", "https://t.me/W_l_N"),],[Button.url("مطـور السـورس", "https://t.me/zzzzl1l"),]]
