...
async def zed(event):
    await edit_or_reply(event, "[ᯓ 𝗧𝗘𝗣𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الـخدمــات العـامــه](t.me/Tepthon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**⎞𝟏⎝** `.الذاتيه`\n\n**⎞𝟐⎝** `.الترحيب`\n\n**⎞𝟑⎝** `.الردود`\n\n**⎞𝟒⎝** `.الاذاعه`\n\n**⎞𝟓⎝** `.التكرار`\n\n**⎞𝟔⎝** `.الكاشف`\n\n**⎞𝟕⎝** `.المساعد`\n\n**⎞𝟖⎝** `.الطقس`\n\n\n 𓆩 [𝗧𝗘𝗣𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/Tepthon) 𓆪")
...
async def zed(event):
    await edit_or_reply(event, "[ᯓ 𝗧𝗘𝗣𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - قائمــة اوامــر التسـليــه 🏂](t.me/Tepthon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**⎞𝟏⎝** `.تسليه1`\n**⎞𝟐⎝** `.تسليه2`\n**⎞𝟑⎝** `.تسليه3`\n**⎞𝟒⎝** `.تسليه4`\n**⎞𝟓⎝** `.تسليه5`\n**⎞𝟔⎝** `.تسليه6`\n**⎞𝟕⎝** `.تسليه7`\n**⎞𝟖⎝** `.تسليه8`\n**⎞𝟗⎝** `.تسليه9`\n**⎞𝟏𝟎⎝** `.تسليه10`\n\n**⎉╎قائـمه اوامــر التسـليـه الجـديـده حقـوق سـورس تيبثـون :**\n\n**⎞𝟏𝟏⎝** `.حيوان` بالـرد\n\n**⎞𝟏𝟐⎝** `.زاحف` بالـرد\n\n**⎞𝟏𝟑⎝** `.مشهور` بالـرد\n\n**⎞𝟏𝟒⎝** `.مشهوره` بالـرد\n\n**⎞𝟏𝟓⎝** `.التحشيش`\n\n**⎞𝟏𝟔⎝** `.معاني` + اسـم\n\n\n 𓆩 [𝗧𝗘𝗣𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/Tepthon) 𓆪")
...
@check_owner
async def zed_handler(zedub):
    text = "[ᯓ 𝗧𝗘𝗣𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الـخدمــات العـامــه](t.me/Tepthon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**⎞𝟏⎝** `.الذاتيه`\n\n**⎞𝟐⎝** `.الترحيب`\n\n**⎞𝟑⎝** `.الردود`\n\n**⎞𝟒⎝** `.الاذاعه`\n\n**⎞𝟓⎝** `.التكرار`\n\n**⎞𝟔⎝** `.الكاشف`\n\n**⎞𝟕⎝** `.المساعد`\n\n**⎞𝟖⎝** `.الطقس`\n\n\n 𓆩 [𝗧𝗘𝗣𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/Tepthon) 𓆪"
    zilzal = [[Button.inline("رجــوع", data="back1")]]
    await zedub.edit(text, buttons=zilzal, link_preview=False)
...
@check_owner
async def zed_handler(zedub):
    text = "[ᯓ 𝗧𝗘𝗣𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - قائمــة اوامــر التسـليــه 🏂](t.me/Tepthon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**⎞𝟏⎝** `.تسليه1`\n**⎞𝟐⎝** `.تسليه2`\n**⎞𝟑⎝** `.تسليه3`\n**⎞𝟒⎝** `.تسليه4`\n**⎞𝟓⎝** `.تسليه5`\n**⎞𝟔⎝** `.تسليه6`\n**⎞𝟕⎝** `.تسليه7`\n**⎞𝟖⎝** `.تسليه8`\n**⎞𝟗⎝** `.تسليه9`\n**⎞𝟏𝟎⎝** `.تسليه10`\n\n**⎉╎قائـمه اوامــر التسـليـه الجـديـده حقـوق سـورس تيبثـون :**\n\n**⎞𝟏𝟏⎝** `.حيوان` بالـرد\n\n**⎞𝟏𝟐⎝** `.زاحف` بالـرد\n\n**⎞𝟏𝟑⎝** `.مشهور` بالـرد\n\n**⎞𝟏𝟒⎝** `.مشهوره` بالـرد\n\n**⎞𝟏𝟓⎝** `.التحشيش`\n\n**⎞𝟏𝟔⎝** `.معاني` + اسـم"
    zilzal = [[Button.inline("رجــوع", data="back1")]]
    await zedub.edit(text, buttons=zilzal, link_preview=False)
...
@check_owner
async def zed_handler(zedub):
    text = "[ᯓ 𝗧𝗘𝗣𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الصيـد & التشيكـر ❇️](t.me/Tepthon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**⎉╎قـائمـة اوامـر تشيكـر صيـد معـرفات تيليجـرام :**\n\n**النـوع :**\n**(** `سداسي حرفين`/`ثلاثيات`/`سداسيات`/`بوتات`/`خماسي حرفين`/`خماسي`/`سباعيات` **)**\n\n**⎞𝟏⎝** `.صيد` + النـوع\n**⪼ لـ صيـد يـوزرات عشوائيـه على حسب النـوع**\n\n**⎞𝟐⎝** `.تثبيت` + اليـوزر\n**⪼ لـ تثبيت اليـوزر بقنـاة معينـه اذا اصبح متاحـاً يتم اخـذه**\n\n**⎞𝟑⎝** `.حالة الصيد`\n**⪼ لـ معرفـة حالـة تقـدم عمليـة الصيـد**\n\n**⎞𝟒⎝** `.حالة التثبيت`\n**⪼ لـ معرفـة حالـة تقـدم التثبيت التلقـائـي**"
...
@check_owner
async def zed_handler(zedub):
    text = "[ᯓ 𝗧𝗘𝗣𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الاضـافة والتفليــش](t.me/Tepthon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**⎉╎قـائمـة اوامـر اضـافة الاعضـاء وتفليـش الكروبـات الخاص بسـورس تيبثـون🦾 :** \n\n**- اولاً اوامــر اضـافة الاعضـاء كالتالـي :**\n\n**⎞𝟏⎝** `.ضيف`\n**⪼ ⦇.ضيف + رابط المجموعـه⦈ لـ اضـافة الاعضـاء استخـدم الامـر بالكـروب الهـدف مع اضافه رابط كروبك لـ الامـر ✓**\n\n\n**- ثانيـاً اوامــر تفليــش الكروبـات كالتالـي :**\n\n**⎞𝟐⎝** `.تفليش`\n**⪼ لـ تفليـش جميـع اعضـاء مجمـوعـه معينـه .. استخـدم الامـر داخـل الكـروب + تحتـاج رتبـة مشـرف بالكـروب ✓**\n\n**⎞𝟑⎝**`.تفليش بالطرد`\n**لـ تفليـش جميـع اعضـاء مجمـوعـه معينـه بالطـرد فقـط وليس بالحظـر .. استخـدم الامـر داخـل الكـروب + تحتـاج رتبـة مشـرف بالكـروب ✓**\n\n**⎞𝟒⎝** `.حظر_الكل`\n**⪼ حظـر وتفليـش اعضـاء الكروب عبر بوت الحماية المرفوع بالكروب + ماتحتاج اشراف انت فقط تحتاج رتبه ادمن ومافوق بالبوت ✓**\n\n**⎞𝟓⎝** `.طرد_الكل`\n**⪼ طـرد وتفليـش اعضـاء الكروب عبر بوت الحماية المرفوع بالكروب + ماتحتاج اشراف انت فقط تحتاج رتبه ادمن ومافوق بالبوت ✓**\n\n**⎞𝟔⎝** `.كتم_الكل`\n**⪼ كتـم اعضـاء الكروب عبر بوت الحماية المرفوع بالكروب + ماتحتاج اشراف انت فقط تحتاج رتبه ادمن ومافوق بالبوت ✓**\n\n**⎞𝟕⎝** `.الغاء التفليش`\n**⪼ لـ الغـاء عمليـة التفليـش او الكتـم الجاريـه وايقافهـا ✓**"
    zilzal = [[Button.inline("رجــوع", data="back2")]]
    await zedub.edit(text, buttons=zilzal, link_preview=False)
...
async def zed_handler(event):
    ...
    if query.startswith("تيبثون") and event.query.user_id == zedub.uid:
        ...
        buttons = [[Button.url("قنـاة السـورس", "https://t.me/Tepthon"),],[Button.url("التحـديثـات", "https://t.me/Tws_Tepthon"), Button.url("الفـارات", "https://t.me/Tepthone1"),],[Button.url("الشـروحـات¹", "https://t.me/Tws_Tepthon"),],[Button.url("كــلايــش تــيــبــثون", "https://t.me/tepthonklaesh"),],[Button.url("مطـور السـورس", "https://t.me/PPF22"),]]
...
async def zed_handler(event):
    ...
    if query.startswith("السورس") and event.query.user_id == zedub.uid:
        ZPIC = gvarstatus("ALIVE_PIC")
        buttons = [[Button.url("قنـاة الســورس", "https://t.me/Tepthon")]]
